"""
src/catboost_test1.py
─────────────────────
CatBoost 단독 실험 파일 #1.

실행:
    python -m src.catboost_test1

출력:
    outputs/catboost_test1_submission.csv
"""
...
OUT_PATH   = "outputs/catboost_test1_submission.csv"
SEED       = 42
N_SPLITS   = 5
...
def main():
    ...
    if recorded:
        ...
        print(f"[tracker] 신기록 아님 → submission 저장 생략")
